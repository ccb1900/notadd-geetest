      ...
      <row>
        <i-col span="12">
          <form-item :label="trans('notadd-geetest.setting.opinions.id.label')" prop="id">
            <i-input :placeholder="trans('notadd-geetest.setting.opinions.id.placeholder')"
                     v-model="form.appid"></i-input>
          </form-item>
        </i-col>
      </row>
      <row>
        <i-col span="12">
          <form-item :label="trans('notadd-geetest.setting.opinions.key.label')" prop="token">
            <i-input :placeholder="trans('notadd-geetest.setting.opinions.key.placeholder')"
                     v-model="form.appkey"></i-input>
          </form-item>
        </i-col>
      </row>
      <row>
